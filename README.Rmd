...
> [!NOTE]
> The model and the values of parameters B1 and B2 are presented in the console prompt and figure.
...
> [!IMPORTANT]
> The `glad_in()` function must be executed in the console; when run from RMarkdown, the prompt appears, but the figure does not.
