...
> **_NOTE:_** The model and the values of parameters B1 and B2 are presented in the console prompt and figure.
...
> **_WARNING:_** The `glad_in()` function must be executed in the console; when
