...
## Sea also
    ...
    `again()` function from simodiff package.
...
## Import from
  grDevices:dev.set, svDialogs:dlgInput    
    
## Example

First, a list of models to be analyzed is defined, including the logistic ('LoM')
models. Second, the initial values of the parameters are established. A data frame
containing the class mark and mature proportion is created.The variable "i"
represents the number of models that will be evaluated.Finally, the labels for 
the x and y axes are defined.

 Aqui me quede desarollando el ejemplo
